...
public:
	...
	//modify by dfn.li 2013-7-6 9:24
	...
	//add by dfn.li
//	void AddCustomStyle(LPCTSTR pStrStyleName, LPCTSTR pStrStyleAttrList);
	void AddCustomStyle(LPCTSTR pStrStyleName,CStdStringPtrMap* pStyleMap);
//	LPCTSTR GetCustomStyleByName(LPCTSTR pStrStyleName) const;
	LPCTSTR GetCustomStyle(LPCTSTR pStrStyleName,LPCTSTR pStrAttrName) const;
	CStdStringPtrMap* GetCustomStyle(LPCTSTR pStrStyleName);
	void RemoveAllStyle();
...
private:
	...
	//modify by dfn.li 2013-8-31
//    HBITMAP m_hbmpBackground;
	LPBYTE m_pBmpAlphaCanvasBits;
	LPBYTE m_pBmpRgbCanvasBits;
	HBITMAP m_hBmpAlphaCanvas;
	HBITMAP m_hBmpRgbCanvas;
    ...
    RECT m_rcCaption;
	//modify by dfn.li 2013-7-6 9:26
	RECT m_rcCaption_Bottom;
	...
	// add by dfn.li
	CStdStringPtrMap m_aUserCustomStyle;
	//end
