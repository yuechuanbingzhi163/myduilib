...
public:
	...
	static HBITMAP LoadBitmap(STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0, HINSTANCE hInstRes = NULL);
	static TImageInfo* LoadImage(STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0,HINSTANCE hInstRes = NULL);
