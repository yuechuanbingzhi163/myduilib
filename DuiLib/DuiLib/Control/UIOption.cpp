...
namespace DuiLib
{
	...
	COptionUI::COptionUI() : m_bSelected(false), m_dwSelectedTextColor(0),m_bNotFilterSelected(false)
	{
	}
	...
	LPCTSTR COptionUI::GetClassName()
	{
		return _T("OptionUI");
	}
	LPCTSTR COptionUI::GetClass() const
	{
		return COptionUI::GetClassName();
	}
	...
	void COptionUI::Selected(bool bSelected,bool bSendMsg /* = true */)
	{
		if( m_bSelected == bSelected && !m_bNotFilterSelected) return;
	...
	void COptionUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if( _tcscmp(pstrName, _T("notfilterselected")) == 0 ) SetNotFilterSelected(_tcscmp(pstrValue, _T("true")) == 0);
	...
	void COptionUI::PaintStatusImage(HDC hDC)
	{
		...
		//支持选中是的hover改变;by daodao 2012-11-21
...
Label_ForeImage:
	...
	void COptionUI::SetNotFilterSelected(bool bNotFilterSelected)
	{
		m_bNotFilterSelected = bNotFilterSelected;
	}

	bool COptionUI::IsNotFilterSelected()const
	{
		return m_bNotFilterSelected;
	}
