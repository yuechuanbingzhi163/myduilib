...
bool CComboUI::SelectItem(int iIndex, bool bTakeFocus,bool bSelected)
{
...
void CComboUI::SetMultiSelect(bool b)
{
	
}
bool CComboUI::IsMultiSelected() const
{
	return false;//add by rz.li
}
