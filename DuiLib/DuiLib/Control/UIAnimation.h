...
namespace DuiLib {
	...
	public:
		...
		virtual BOOL IsAnimationRunning(int nAnimationID) const = 0;
		virtual int GetCurrentFrame(int nAnimationID = 0) const = 0;
	...
	public:
		...
		virtual BOOL IsAnimationRunning(int nAnimationID) const;
		virtual int GetCurrentFrame(int nAnimationID = 0) const;
	...
	protected:
		CAnimationData* GetAnimationDataByID(int nAnimationID) const;
		void RemoveAnimationData(CAnimationData* pData);
