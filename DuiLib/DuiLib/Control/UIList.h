...
public:
    ...
    virtual bool SelectItem(int iIndex, bool bTakeFocus = false,bool bSelected = true) = 0;
...
// class UILIB_API CMenuContainerElementUI : public CContainerUI, public IListItemUI
// {
// public:
// 	CMenuContainerElementUI();
// 	~CMenuContainerElementUI();
// 
// 	static LPCTSTR GetClassName();
// 	LPCTSTR GetClass() const;
