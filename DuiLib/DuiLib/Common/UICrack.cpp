...
// FlashUI
const TCHAR* const kFlashUIClassName = _T("FlashUI");
const TCHAR* const kFlashUIInterfaceName = _T("Flash");
...
// WbkWebkitUI
const TCHAR* const kWkeWebkitUIClassName = _T("WbkWebkitUI");
const TCHAR* const kWkeWebkitUIInterfaceName = _T("WbkWebkit");
/////////////////////////////////////////////////////////////////////////////////////
//
//
...
const TCHAR* const kDBClick = _T("dbclick");
...
const TCHAR* const kMenuItem = _T("menuItem");
const TCHAR* const kItemDBClick = _T("itemdbclick");
}; // namespace DuiLib