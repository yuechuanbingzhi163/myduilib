...
namespace DuiLib
{
	...
	void SoundEngine::preloadBackgroundMusic( CDuiString strFilePath )
	{

	}

	void SoundEngine::playBackgroundMusic( CDuiString strFilePath, bool bLoop )
	{
	...
	unsigned int SoundEngine::playEffect( CDuiString strFilePath, bool bLoop )
	{
		return 0;
	}
	...
	void SoundEngine::preloadEffect( CDuiString strFilePath )
	{

	}

	void SoundEngine::unloadEffect( CDuiString strFilePath )
	{

	}

	int SoundEngine::Return_Max()
	{
		return 0;
	}

	void SoundEngine::Soundend()
	{

	}

	void SoundEngine::Musicend()
	{
